...
public class CoursRechercher {
	...
	public CoursRechercher(Caracteristique speficite, Instrument instrument, Cycles cycle, Site site, int distance) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CoursRechercher other = (CoursRechercher) obj;
		if (cycle == null) {
			if (other.cycle != null)
				return false;
